...
class User(models.Model):
	...
	def insertObjects(self):
		try:
			temp = User(userName = "Edward Peter Chen", balance = 0, mpScore = 100, sp=0)
			temp.save()
			temp = User(userName = "Peter Chen", balance = 0, mpScore = 20, sp=0)
			temp.save()
			temp = User(userName = "Bing Chong Lim", balance = 0, mpScore = 4, sp=0)
			temp.save()
			temp = User(userName = "Charls Gao", balance = 0, mpScore = 3, sp=0)
			temp.save()
			temp = User(userName = "Test User I", balance = 0, mpScore = 2, sp=0)
			temp.save()
			temp = User(userName = "Test User II", balance = 0, mpScore = 1, sp=0)
			temp.save()
			temp = User(userName = "Test User III", balance = 0, mpScore = 0, sp=0)
			temp.save()
			temp = User(userName = "Test User IV", balance = 0, mpScore = 0, sp=0)
			temp.save()
			temp = User(userName = "Test User V", balance = 0, mpScore = 0, sp=0)
			temp.save()
			temp = User(userName = "Test User VI", balance = 0, mpScore = 0, sp=0)
			temp.save()
			return (SUCCESS,{})
...
class SingleTopTen(models.Model):
	...
	def insertObjects(self):
		try:
			temp  = SingleTopTen(100)
			temp.save()
			temp  = SingleTopTen(64)
			temp.save()
			temp  = SingleTopTen(42)
			temp.save()
			temp  = SingleTopTen(41)
			temp.save()
			temp  = SingleTopTen(23)
			temp.save()
			temp  = SingleTopTen(0)
			temp.save()
			temp  = SingleTopTen(0)
